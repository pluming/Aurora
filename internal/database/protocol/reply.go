...
func MakeMultiRawReply(replies []client.Reply) *MultiRawReply {
...
func IsOKReply(reply client.Reply) bool {
...
// ErrorReply is an error and client.Reply
...
func IsErrorReply(reply client.Reply) bool {
